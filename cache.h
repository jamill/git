...
/*
 * Create a cache_entry using the arguments passed in. This will
 * allocate memory for the cache_entry. Caller is responsible for
 * discarding the cache_entry with `cache_entry_discard`.
 */
extern struct cache_entry *make_index_cache_entry(struct index_state *state, unsigned int mode, const unsigned char *sha1, const char *path, int stage, unsigned int refresh_options);

/*
 * Create a cache_entry that is not intended to be added to an index
 * using the arguments passed in. This will allocate memory for the
 * cache_entry. Caller is responsible for discarding the cache_entry
 * with `cache_entry_discard`.
 *
...
/*
 * Create an empty cache entry struct. This will allocate memory for a
 * cache_entry with a path length of `path_len'. Caller is responsible
 * for discarding the cache entry with `cache_entry_discard.
 *
 * Create an empty cache entry struct. This is intended for use with
